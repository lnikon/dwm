...
/* tagging */
static const char *tags[] = { "1:web", "2:dev", "3:term", "4:file", "5:media", "6", "7", "8", "9" };
...
static const char *music[]   =  { "vkaudiosaver", NULL };
static const char *pdfread[] =  { "evince", NULL };
/* static const char *djview[] =   { "djview4", NULL }; */
...
static Key keys[] = {
	...
	{ MODKEY,			XK_s,	   spawn,	   {.v = fileman } },
	{ MODKEY,			XK_v,      spawn,	   {.v = music } },
	{ MODKEY,			XK_q,      spawn,	   {.v = pdfread } },
